...
import com.wen.im.api.media.callback.*;
import com.wen.im.api.media.sdk.core.ZLMApi;
import com.wen.im.api.media.sdk.structure.MK_EVENTS;
import com.wen.im.api.media.sdk.structure.MK_INI;
...
public class MediaServerContext {
    private static final Logger log = LoggerFactory.getLogger(MediaServerContext.class);
    @Autowired
    private MediaServerConfig config;
    public static ZLMApi ZLM_API = null;
    private static com.wen.im.api.media.sdk.structure.MK_EVENTS MK_EVENTS = null;
