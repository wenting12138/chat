 ...
 */
@Component
public class CallSendOfferProcessor implements NettySpringWebsocketRemotingProcessor {
    ...
    public void handleBackendRequest(ImRequest request) {
        ...
        ImResponse response = ImResponse.result(ResponseCode.CALL_SEND_OFFER, request.getBody(), "");
    ...
    public RequestCode getRequestCode() {
        return RequestCode.SEND_OFFER_REQ;
    }
