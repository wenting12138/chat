...
import com.wen.im.api.media.callback.MKSourceFindCallBack;
import com.wen.im.api.media.sdk.callback.IMKProxyPlayCloseCallBack;
import com.wen.im.api.media.sdk.structure.MK_MEDIA_SOURCE;
import com.wen.im.api.media.sdk.structure.MK_PROXY_PLAYER;
import com.wen.im.api.media.sdk.structure.MK_TRACK;
import com.wen.im.api.service.IMediaService;
import com.wen.im.common.constants.MediaServerConstants;
import com.wen.im.common.model.dto.media.param.*;
import com.wen.im.common.model.dto.media.result.MediaInfoResult;
import com.wen.im.common.model.dto.media.result.Track;
 ...
 */
@Service
public class MediaServerImpl implements IMediaService {
