  ...
  onMessage = (value: string) => {
    ...
    switch (params.type) {
      ...
      case WsResponseMessageType.CALL_ACCEPT_RES:
          callStore.callerReceiveAcceptCall()
          break
      case WsResponseMessageType.CALL_SEND_OFFER_RES:
          callStore.calledReceiveOffer(params.data.offer)
          break
      case WsResponseMessageType.CALL_SEND_ANSWER_RES:
          callStore.callerReceiveAnswer(params.data.answer)
          break
      case WsResponseMessageType.CALL_SEND_CANDIDATE_RES:
          callStore.calledReceiveCandidate(params.data.candidate)
          break
